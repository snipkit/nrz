...
describe('Footer Component', () => {
  it('renders all the social icons', () => {
    const socialMediaLinks = [
      {
        name: 'linkedin',
        url: 'https://www.linkedin.com/company/nrz/',
      },
      { name: 'twitter-x', url: 'https://x.com/nrz' },
      { name: 'github', url: 'https://github.com/khulnasoft' },
      { name: 'discord', url: 'https://discord.gg/nrz' },
    ]
