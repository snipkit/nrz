...
\`\`\`
nrz cache <command> [flags]
\`\`\`

Work with nrz cache folders
...
\`\`\`
nrz cache add <package-spec> [<package-spec>...]
\`\`\`
...
\`\`\`
nrz cache delete-before <date>
\`\`\`

### delete-all

Delete the entire cache folder to make nrz slower.

\`\`\`
nrz cache delete-all
\`\`\`
...
\`\`\`
nrz cache nrz cache ls https://registry.npmjs.org/typescript
\`\`\`

Add a given package specifier to the cache by fetching its resolved value.

\`\`\`
nrz cache nrz cache add eslint@latest
\`\`\`

Print the cache metadata to stderr, and write the tarball on stdout, redirecting to a file.

\`\`\`
nrz cache nrz cache info https://registry.npmjs.org/eslint/-/eslint-9.25.1.tgz > eslint.tgz
\`\`\`

Delete all entries created before Jan 1, 2025

\`\`\`
nrz cache nrz cache delete-before 2025-01-01
\`\`\`
