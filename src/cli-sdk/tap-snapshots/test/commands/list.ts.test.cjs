...
Usage:
  nrz ls
  nrz ls [query | specs] [--view=human | json | mermaid | gui]
...
workspace.
  ...
  Examples
    ...
    ​nrz ls '[name="@scoped/package"] > *'

    List all peer dependencies of all workspaces

    ​nrz ls '*:workspace > *:peer'
...
[
  ...
  },
  {
    ...
    "to": {
      ...
      "name": "@foo/bazz",
      "version": "1.0.0",
      "location": "./node_modules/.nrz/··@foo§bazz@1.0.0/node_modules/@foo/bazz",
      "importer": false,
      "manifest": {
        "name": "@foo/bazz",
        "version": "1.0.0"
