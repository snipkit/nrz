...
import { isObject } from '@nrz/types'
...
export const usage: CommandUsage = () =>
  commandUsage({
    command: 'config',
    usage: '<command> [flags]',
    description: 'Work with nrz configuration',
    ...
    subcommands: {
      ...
      set: {
        ...
        description: `Set config values. By default, these are
                      written to the project config file, \`nrz.json\`
      ...
      del: {
        ...
        description: `Delete the named config fields. If no values remain in
                      ...
                      operates on the \`nrz.json\` file in the root of the
