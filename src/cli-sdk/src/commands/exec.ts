...
import type { PromptFn } from '@nrz/nrx'
...
export const usage: CommandUsage = () =>
  commandUsage({
    ...
    description: `Run a command defined by a package, installing it
                  ...
                  If \`--package\` is not set, then nrz will attempt to infer
                  ...
                  - Otherwise, nrz attempts to resolve the first argument
                  ...
                  At no point will \`nrz exec\` change the locally installed
                  dependencies. Any installs it performs is done in nrz's XDG
                  data directory.
    `,
    examples: {
