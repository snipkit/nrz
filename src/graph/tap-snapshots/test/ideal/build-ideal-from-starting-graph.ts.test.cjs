  ...
  Node {
    ...
    edgesOut: [
      Edge spec(baz@^1.0.0) -prod-> to: Node {
        id: '··baz@1.0.0',
        location: './node_modules/.nrz/··baz@1.0.0/node_modules/baz',
  ...
  Node {
    ...
    edgesOut: [
      ...
      Edge spec(missing@^1.0.0) -prod-> to: Node {
        id: '··missing@1.0.0',
        location: './node_modules/.nrz/··missing@1.0.0/node_modules/missing',
        resolved: 'https://registry.npmjs.org/missing/-/missing-1.0.0.tgz'
      },
      Edge spec(pnpmdep@1) -prod-> to: Node {
        id: '··pnpmdep@1.0.0',
        location: './node_modules/.nrz/··pnpmdep@1.0.0/node_modules/pnpmdep',
      ...
      Edge spec(ipsum@github:lorem/ipsum) -prod-> to: Node {
        ...
        location: './node_modules/.nrz/git·github%3Alorem§ipsum·/node_modules/ipsum',
