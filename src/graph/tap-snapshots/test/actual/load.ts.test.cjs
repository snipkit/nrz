  ...
  Node {
    ...
    edgesOut: [
      Edge spec(a@^1.0.0) -prod-> to: Node {
        id: '··a@1.0.0',
        location: './node_modules/.nrz/··a@1.0.0/node_modules/a',
        edgesOut: [
          Edge spec(b@^1.0.0) -prod-> to: Node {
            id: '··b@1.0.0',
            location: './node_modules/.nrz/··b@1.0.0/node_modules/b',
  ...
  Node {
    ...
    edgesOut: [
      ...
      Edge spec(c@^1.0.0) -prod-> to: Node {
        ...
        location: './node_modules/.nrz/··c@1.0.0·%3Aroot%20%3E%20%23c%20%3E%20%23d/node_modules/c'
      },
      Edge spec(b@^1.0.0) -prod-> to: Node {
        id: '··b@1.0.0·%3Aroot%20%3E%20%23b',
        location: './node_modules/.nrz/··b@1.0.0·%3Aroot%20%3E%20%23b/node_modules/b'
      },
      Edge spec(a@^1.0.0) -prod-> to: Node {
        id: '··a@1.0.0',
        location: './node_modules/.nrz/··a@1.0.0/node_modules/a'
  ...
  Node {
    ...
    edgesOut: [
      ...
      Edge spec(extraneous@*) -prod-> to: Node {
        id: '··extraneous@1.0.0',
        location: './node_modules/.nrz/··extraneous@1.0.0/node_modules/extraneous'
      },
      Edge spec(bar@^1.0.0) -optional-> to: Node {
        ...
        edgesOut: [
          Edge spec(blooo@1) -prod-> to: Node {
            id: '··blooo@1.0.0',
            location: './node_modules/.nrz/··blooo@1.0.0/node_modules/blooo',
            optional: true
          },
          Edge spec(baz@custom:baz@^1.0.0) -prod-> to: Node {
            id: '·custom·baz@1.0.0',
            location: './node_modules/.nrz/·custom·baz@1.0.0/node_modules/baz',
            optional: true
          }
        ]
      },
      Edge spec(aliased@custom:foo@^1.0.0) -dev-> to: Node {
        id: '·custom·foo@1.0.0',
        location: './node_modules/.nrz/·custom·foo@1.0.0/node_modules/foo',
        dev: true
      },
      Edge spec(@scoped/b@^1.0.0) -prod-> to: Node {
        id: '··@scoped§b@1.0.0',
        location: './node_modules/.nrz/··@scoped§b@1.0.0/node_modules/@scoped/b',
        edgesOut: [
          Edge spec(@scoped/c@^1.0.0) -prod-> to: Node {
            id: '··@scoped§c@1.0.0',
            location: './node_modules/.nrz/··@scoped§c@1.0.0/node_modules/@scoped/c'
          }
        ]
      },
      Edge spec(@scoped/a@^1.0.0) -prod-> to: Node {
        id: '··@scoped§a@1.0.0',
        location: './node_modules/.nrz/··@scoped§a@1.0.0/node_modules/@scoped/a'
      },
  ...
  Node {
    ...
    edgesOut: [
      ...
      Edge spec(ipsum@^1.0.0) -dev-> to: Node {
        id: '··ipsum@1.0.0',
        location: './node_modules/.nrz/··ipsum@1.0.0/node_modules/ipsum',
        dev: true
      },
