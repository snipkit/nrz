...
import * as GRAPH from '@nrz/graph'
...
import type { NrzServerListening } from '../src/index.ts'
...
const mockServer = ms as unknown as NrzServerListening
t.beforeEach(t => {
