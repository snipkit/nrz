...
Facilities for finding, loading, and updating the `nrz.json` nrz
project configuration file.

## Usage

```js
import { find, load, save } from '@nrz/xdg'
...
// of nrz all trying to write to it. Once the validator function
