...
t.test('isProjectTools', async t => {
  t.ok(isProjectTools('nrz'), 'should return true for nrz')
  t.notOk(
...
t.test('asProjectTools', async t => {
  const tool: ProjectTools = asProjectTools('nrz')
  t.equal(tool, 'nrz', 'should return type casted string')
  t.throws(
...
t.test('getGraphProjectData', async t => {
  ...
  t.matchSnapshot(
    ...
    'should return the correct graph project data for a nrz project',
  )
  ...
  t.matchSnapshot(
    ...
    'should return the correct graph project data for a non-installed nrz project',
  )
...
t.test('getGraphProjectData empty nrz-installed project', async t => {
  const dir = t.testdir({
    home: {
      user: {
        projects: {
  ...
  t.matchSnapshot(
    ...
    'should return nrzInstalled: true for an empty but installed project',
  )
})
