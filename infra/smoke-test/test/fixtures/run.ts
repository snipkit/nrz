...
import { whichSync } from '@nrz/which'
import {
  BINS_DIR,
  createArtifacts,
  createVariants,
  ...
  VARIANTS,
  PUBLISHED_VARIANT,
} from '@nrz/infra-build'
import type { Bin, Variant, VariantOptions } from '@nrz/infra-build'

// only bundle/compile the nrz binary since that is all we test
// this makes the tests run faster
export const Bins = ['nrz'] as const
